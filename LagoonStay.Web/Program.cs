...
StripeConfiguration.ApiKey = builder.Configuration.GetSection("Stripe:SecretKey").Get<string>(); //This line retrieves the Stripe secret key from the configuration and sets it for use in the application.
